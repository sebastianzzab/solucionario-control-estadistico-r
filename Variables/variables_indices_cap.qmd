...
<br/>Una empresa de producción de alimentos se encuentra interesada en supervisar la concentración de un conservante en los productos que derece, para ello toman entre 10 y 15 muestras de 20 lotes de producción distintos, midiendo la concentración del conservante en su respectiva unidad.
...
La interpretación de los gráficos de control de individuales y rango móvil (I-MR) (@fig-MRinicial-highcharter-def y @fig-x-inicial-highcharter-def) para el tiempo de respuesta a solicitudes de servicio de clientes internos indica que el proceso se encuentra en estado de control estadístico. Esto significa que la variabilidad del proceso y su centrado son estables y predecibles.
